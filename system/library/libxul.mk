...
EXTRA_DEPS += $(topsrcdir)/system/library/libxul.mk

ifeq (Linux,$(OS_ARCH))
OS_LDFLAGS += -Wl,-version-script,symverscript

symverscript: $(topsrcdir)/system/library/symverscript.in
...
LIBXUL_AUTOLOAD = $(topsrcdir)/system/library/libxul.so-gdb.py.in
...
ifdef LD_IS_BFD
OS_LDFLAGS += $(topsrcdir)/system/library/StaticXULComponents.ld
endif
endif
endif
